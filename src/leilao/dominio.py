...
class Usuario:
    ...
    def propoe_lance(self, leilao, valor):
        if not self._valor_eh_valido(valor):
            raise LanceInvalido('Nâo pode propor um lance com o valor maior que o valor da carteira')
...
class Leilao:
    ...
    def _lance_eh_valido(self, lance):
        return not self._tem_lances() or (self._usuarios_diferente(lance) and
